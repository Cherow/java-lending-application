...
public class LoanWrittenOffEventHandler implements NotificationEventHandler {
    ...
    public NotificationEventType getEventType() {
        return NotificationEventType.LOAN_WRITTEN_OFF;
    }
    ...
    public void handle(String request) {
        try {
            ...
            throw new RuntimeException("Failed to handle LOAN_WRITTEN_OFF event", ex);
        }
    }
}